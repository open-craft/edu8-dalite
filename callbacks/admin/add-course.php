...
function post(&$a) {
    if (isset($a['request']['file'])) {
        ...
        foreach ($file as $line) {
            ...
            system('mysqlimport --ignore-lines=1 -vv --local --columns=login,password,firstname,lastname --fields-optionally-enclosed-by="\"" --fields-terminated-by="," -u root --password=ayokch dalite /tmp/student.csv', $noerr);
